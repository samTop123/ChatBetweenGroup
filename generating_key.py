...
class KeyAndCertificateValidator(object):
    @staticmethod
    ...
    def create_key_and_certificate() -> None:
        private_key = KeyAndCertificateValidator.create_private_key()

        public_key = private_key.public_key()

        subject = issuer = KeyAndCertificateValidator.create_subject()
        ...
        cert = KeyAndCertificateValidator.create_certificate(subject, issuer, private_key, public_key)
